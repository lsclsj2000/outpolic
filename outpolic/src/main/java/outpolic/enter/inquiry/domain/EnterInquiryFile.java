...
public class EnterInquiryFile {
    ...
    // 기본 생성자
    public EnterInquiryFile() {}

    // Builder 패턴을 위한 private 생성자
    private EnterInquiryFile(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(EnterInquiryFile attachment) {
        ...
        public EnterInquiryFile build() {
            return new EnterInquiryFile(this);
        }
    }
}
