...
public class EnterCompanyController {
    ...
    public String companyProfileView(@PathVariable String entCd, Model model) {
        ...
        EnterCompanyProfileDTO companyProfile = enterCompanyService.getCompanyProfile(entCd);
        ...
        return "enter/company/enterCompanyProfileView";
    }
}
