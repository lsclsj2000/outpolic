...
public class EnterCategoryController {
    ...
    @GetMapping("/enter/category/products")
    public String showContentsBySubCategory(@RequestParam("category") String subCategoryCode, Model model) {
        ...
        EnterCategory currentCategory = categoryService.getMainCategory(subCategoryCode);
        
        model.addAttribute("currentCategory", currentCategory);
        
        List<EnterContentItemDTO> contents = searchService.findContentsByCategoryId(subCategoryCode);
