...
public class AdminAnnFile {
    ...
    private AdminAnnFile(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(AdminAnnFile attachment) {
        ...
        public AdminAnnFile build() {
            return new AdminAnnFile(this);
        }
    }
}
