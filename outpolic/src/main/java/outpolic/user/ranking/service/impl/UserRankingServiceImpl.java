...
public class UserRankingServiceImpl implements UserRankingService{
	...
	/*
	 * @Autowired private UserRankingMapper userRankingMapper;
	 * 
	 ...
	 * 
	 * 
	 * @Override public List<UserPortfolioRankingContentsDTO>
	 * getUserRankingPoContents() { return
	 * userRankingMapper.getUserRankingPoContents(); }
	 */
}
