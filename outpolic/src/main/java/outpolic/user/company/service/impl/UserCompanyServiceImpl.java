package outpolic.user.company.service.impl;
...
import outpolic.user.company.mapper.UserCompanyMapper;
...
public class UserCompanyServiceImpl implements UserCompanyService{
    ...
    public UserCompanyProfileDTO getCompanyProfile(String entCd) {
        
        // 1. Mapper를 호출하여 기본 정보와 리뷰 요약을 가져옵니다.
        UserCompanyProfileDTO profile = userCompanyMapper.getCompanyInfoById(entCd);
        ...
        List<String> categories = userCompanyMapper.getCompanyCategoriesById(entCd);
     ...
     */
    @Override
    public List<UserCompanyPortfolioDTO> getCompanyPortfolios(String entCd) {
        return userCompanyMapper.getCompanyPortfoliosById(entCd);
    }
     ...
     */
    @Override
    public List<UserCompanyOutsourcingDTO> getCompanyOutsourcing(String entCd) {
        return userCompanyMapper.getCompanyOutsourcingById(entCd);
    }
     ...
     */
    @Override
    public List<UserCompanyReviewDTO> getCompanyReviews(String entCd) {
        return userCompanyMapper.getCompanyReviewsById(entCd);
    }
}
