...
- 후기 작성 하세요
### 유사랑
- 직접 구현한 고객센터와 외주 관리 기능을 통해 사용자 중심의 개발 경험을 쌓았고, 설계부터 배포까지 전 과정을 겪으며 기능별 흐름과 데이터 구조에 대한 이해를 깊이 있게 다질 수 있었습니다. 또한, 협업 과정 속에서 문제를 함께 해결해 나가는 팀워크의 힘을 체감할 수 있었습니다.
