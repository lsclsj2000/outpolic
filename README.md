...
| 신세영 | 공통</br>1. 인터셉터 작업</br></br>2. 로그인 기능</br></br>3. 로그아웃 기능</br></br>User</br>1. 회원가입</br>-- 일반 유저 회원가입</br>-- 기업 회원으로 전환</br></br>2. 비밀번호 변경</br></br>3. 회원 탈퇴</br></br>4. 일반 유저 마이페이지</br>-- 마이페이지 메인(전체)</br>-- 마이페이지 개인정보 수정</br>-- 마이페이지 프로필 사진 수정</br></br>Enter</br>1. 기업 유저 마이페이지</br>-- 마이페이지 메인(전체)</br>-- 마이페이지 기업정보 수정</br>-- 마이페이지 개인 정보 수정</br></br>Admin</br>1. 관리자 로그인</br></br>2. 회원 리스트</br>-- 회원 목록 조회</br>-- 회원 검색/정렬</br>-- 회원 정보 수정</br></br>3. 기업 리스트</br>-- 기업 목록 조회</br>-- 기업 검색/정렬</br>-- 기업 정보 수정</br></br>4. 로그인 기록 확인</br>-- 로그인 기록 검색</br>-- 최근 로그인 수 그래프 조회</br></br>5. 관리자 권한 설정</br>-- 관리자 권한 조회/수정</br></br> |
