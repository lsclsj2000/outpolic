...
| 신세영 | User<br>1. 회원가입<br>-- 일반 유저 회원가입<br>-- 기업회원으로 전환(일반회원 로그인 후)<br><br>2. 비밀번호 찾기<br><br>3. 일반유저 마이페이지(로그인 후 사용)<br>-- 마이페이지 메인<br>-- 마이페이지 개인정보 수정<br><br>Enter<br>1. 기업 유저 마이페이지(로그인 후 사용)<br>-- 마이페이지 메인<br>-- 마이페이지 정보수정 선택페이지(개인정보 수정할지 기업정보 수정할지 선택하는 페이지)<br>-- 마이페이지 기업 정보 수정<br>-- 마이페이지 개인 정보 수정<br><br>Admin<br>1. 관리자 로그인<br><br>2. 회원 리스트(상세보기 클릭시 모달창)<br>-- 전체 회원 리스트<br>-- 활성 회원 리스트<br>-- 휴면 회원 리스트<br>-- 탈퇴 회원 리스트<br>-- 제재 회원 리스트 |
